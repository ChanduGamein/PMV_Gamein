...
namespace ReadyPlayerMe
{
    ...
    public class EditorAvatarLoader: AvatarLoaderBase
    {
        ...
        protected override IEnumerator LoadAvatarAsync(AvatarUri2 uri)
        {
        ...
        protected override IEnumerator DownloadAvatar(AvatarUri2 uri)
        {
        ...
        /// </summary>
        private GameObject InstantiateAvatar(AvatarUri2 uri)
        {
            #if UNITY_EDITOR
